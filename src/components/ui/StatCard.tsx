...
export function StatCard({
  ...
  return (
    <div className="rounded-2xl bg-kat-surface p-5 shadow-xs border border-kat-border/40">
      ...
      <p className="mt-1 wrap-break-word text-xl font-bold text-kat-text">{value}</p>
    </div>
  );
}
