...
export const GlobalToast = () => {
  ...
  useEffect(() => {
    ...
    const handleToast = (e: any) => {
      ...
      hideTimeoutId = setTimeout(() => {
        setIsShowing(false);
        // Wait for exit animation (250ms) before removing from DOM
        removeTimeoutId = setTimeout(() => setToast(null), 250);
      }, 3000);
    };
  ...
  return createPortal(
    <div
      className={`fixed bottom-24 left-1/2 -translate-x-1/2 z-[99999] px-4 w-full max-w-[400px] pointer-events-none ${isShowing ? "motion-toast-enter" : "motion-toast-exit"}`}
    >
      <div
