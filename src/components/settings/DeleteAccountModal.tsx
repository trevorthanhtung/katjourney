    ...
    <TypedDeleteConfirmModal
      ...
      description={
        <div className="space-y-4">
          <p className="text-[14px] text-slate-700">{t("settings.dialogs.deleteAccount.desc")}</p>
          <div className="bg-slate-100 p-3.5 rounded-xl text-left">
            <p className="font-bold text-slate-700 text-[13px] mb-1">
              {t("settings.dialogs.deleteAccount.deletedData")}
            </p>
