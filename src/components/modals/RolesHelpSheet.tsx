...
export function RolesHelpSheet({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  const roles = [
    ...
    },
    {
      ...
      icon: CompassIcon,
      colorClass:
        "bg-sky-50 text-sky-600 border-sky-200/50 dark:bg-sky-950/20 dark:text-sky-400 dark:border-sky-900/30",
    ...
    },
    {
      ...
      icon: UserGroupIcon,
      colorClass:
        "bg-slate-50 text-slate-600 border-slate-200/50 dark:bg-slate-800 dark:text-slate-400 dark:border-slate-700/50",
