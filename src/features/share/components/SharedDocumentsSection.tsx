  ...
  return (
    <>
      <section className="bg-white/60 dark:bg-slate-900/40 backdrop-blur-xl rounded-[24px] border border-slate-200/50 dark:border-white/5 p-5 shadow-soft hover:shadow-md transition-all duration-300 relative overflow-hidden">
        ...
        {/* Sub Tabs */}
        <div className="flex bg-slate-100/80 dark:bg-slate-800/50 p-1 rounded-xl gap-1 mb-4 relative z-0">
          <button
            type="button"
        ...
        {/* Add Button for Private Documents (Desktop) */}
        {activeSubTab === "private" && (
          <button
            onClick={startAdd}
      ...
      {activeSubTab === "private" && (
        <button
          ...
          aria-label={t("documents.addPrivate")}
          title={t("documents.addPrivate")}
        >
