      ...
      <div className="max-w-[1280px] mx-auto w-full flex items-center justify-between h-9 md:h-11 gap-1.5 min-[390px]:gap-2">
        <div className="flex items-center gap-1.5 min-[390px]:gap-2 select-none shrink-0">
          <img
            ...
            className="hidden md:block h-[26px] w-[26px] min-[390px]:h-[28px] min-[390px]:w-[28px] shrink-0 object-contain drop-shadow-xs"
          />
        ...
        <div className="flex items-center gap-1.5 min-[390px]:gap-2 shrink-0">
          ...
          <button
            onClick={onExit}
            className="flex items-center justify-center min-h-[34px] min-[390px]:min-h-[38px] text-[12px] min-[390px]:text-[13px] font-black text-white dark:text-slate-950 bg-[#030D2E] dark:bg-white hover:bg-[#0a1a5c] dark:hover:bg-slate-100 px-4 rounded-xl shadow-xs transition-all active:scale-[0.97] whitespace-nowrap shrink-0"
          >
            {t("sharedScreen.exit")}
          </button>
        </div>
