...
**Thông điệp cho AI**: Khi đọc được file này, hãy confirm với User rằng "Tôi đã đọc AI_HANDOFF và hiểu rõ luật chơi của Kat Journey. Chế độ UI/UX Freeze đang được bật, tôi sẽ chỉ tập trung vào hiệu năng và logic!"
